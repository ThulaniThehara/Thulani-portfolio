  ...
  return (
    <group position={[0, 0, 0]}>
      ...
      <mesh ref={ring1Ref}>
        ...
        <meshBasicMaterial color="#8FD6E9" transparent opacity={0.5} />
      </mesh>

      <mesh ref={ring2Ref} rotation={[Math.PI / 3, 0, 0]}>
        <torusGeometry args={[1.05, 0.012, 12, 32]} />
        <meshBasicMaterial color="#03045A" transparent opacity={0.35} />
      </mesh>
...
const Scene: React.FC<{
  ...
  return (
    <>
      ...
      <pointLight position={[-4, -4, 2]} intensity={0.6} color="#8FD6E9" />
